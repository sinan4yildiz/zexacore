    ...
    <article class="grid grid-cols-12 gap-6">
      ...
      <div class="col-span-full lg:col-span-4 xl:col-span-3">
        <ul class="bg-gray-50 shadow overflow-hidden rounded-lg">
          ...
          <li v-if="form.language_code != config.default_language_code" class="border-b px-4 py-4 items-center xl:px-6">
            <div>
            ...
            <div class="mt-2 mb-1">
              <Autocomplete name="translation_id" :placeholder="$t('placeholder.search_articles')" action="Articles/articleAutocomplete" :params="{language_code: config.default_language_code}" @input="form.translation_id = $event" :errors="errors"/>
            </div>
          </li>
          <li class="border-b px-4 py-4 items-center xl:px-6">
            <div>
