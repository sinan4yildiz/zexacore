  ...
  <div class="field w-full" v-bind:class="classes">
    ...
    <span class="block relative">
      <input v-model="inputValue" :type="inputType" :name="name" :id="'field-' + name" :placeholder="inputPlaceholder" v-bind="attr"
             class="form-input block w-full px-4 py-3 text-sm border border-gray-400 focus:border-blue-400 focus:shadow-outline-blue rounded-md shadow-sm transition duration-150 ease-in-out" v-bind:class="{'has-error': error}">
