<template>
  <div class="flex w-full switcher" :class="classes">
    <label :for="name" :class="{'required': required}" class="inline-flex relative items-center cursor-pointer">
      ...
      <div class="flex absolute top-1/2 left-0.5 justify-center items-center w-6 h-6 bg-white rounded-full shadow transition duration-150 ease-in-out transform -translate-y-1/2 switcher-dot"></div>
