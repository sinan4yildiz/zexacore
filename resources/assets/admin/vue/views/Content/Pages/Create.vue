  ...
  <section>
    <header class="md:flex md:items-center mb-5">
      ...
      <div class="mb-4 md:mb-0">
        <h1 class="mb-2 text-2xl lg:text-3xl leading-8 lg:leading-9 text-gray-800 truncate">{{ $t('pages.heading.create') }}</h1>
      ...
      <div class="col-span-full lg:col-span-4 xl:col-span-3">
        <ul class="overflow-hidden xl:py-2 bg-gray-50 rounded-lg shadow">
          ...
          <li v-if="form.language_code != settings.default_language_code" class="items-center py-4 px-4 xl:px-6 border-b">
            ...
            <div class="mt-2 mb-1">
              <Autocomplete name="translation_id" :placeholder="$t('placeholder.search_pages')" action="Pages/pageAutocomplete" :params="{language_code: settings.default_language_code}" @input="form.translation_id = $event" :errors="errors"/>
            </div>
          </li>
